...
The `wait_time_model.pkl` (434 MB RandomForest) was trained on real-world crowd trajectory datasets combined with HITEX-specific simulation parameters:
...
| **Pedestrian trajectory data** | [Stanford Drone Dataset](https://www.kaggle.com/datasets/aryashah2k/stanford-drone-dataset) — real overhead drone footage of pedestrian flow in public spaces |
| **Multi-scene crowd flow** | [OpenTraj](https://github.com/crowdbotp/OpenTraj) — unified benchmark of 40+ crowd trajectory datasets across venues and streets |
| **Path planning patterns** | [Path Planning Dataset](https://www.kaggle.com/datasets/mehdimka/path-planning) — structured path decision data used to train route congestion weights |
| **Wait time ground truth** | Simulated using queuing theory (M/M/c model) applied to the trajectory densities above |
| **Event themes & phases** | Parameterized from historical HITEX public event schedules (2022–2024) |

**No personally identifiable information (PII), private operator data, or proprietary HITEX system data was used.**
All datasets are publicly available and used in accordance with their respective licenses.

### Dataset Citations

#### Stanford Drone Dataset
> Robicquet, A., Sadeghian, A., Alahi, A., & Savarese, S. (2016).
> *Learning Social Etiquette: Human Trajectory Understanding in Crowded Scenes.*
> European Conference on Computer Vision (ECCV).
> 🔗 [kaggle.com/datasets/aryashah2k/stanford-drone-dataset](https://www.kaggle.com/datasets/aryashah2k/stanford-drone-dataset)

#### OpenTraj — Multi-Scene Crowd Trajectory Benchmark
> Amirian, J., Zhang, B., Castro, F. V., Baldelomar, J. J., Hayet, J. B., & Pettre, J. (2020).
> *OpenTraj: Assessing Prediction Complexity in Human Trajectories Datasets.*
> Asian Conference on Computer Vision (ACCV).
> 🔗 [github.com/crowdbotp/OpenTraj](https://github.com/crowdbotp/OpenTraj)

#### Path Planning Dataset
> Mohammadi, M. (2022). *Path Planning Dataset.*
> Kaggle public dataset — structured navigation decision data across 2D grid environments.
> 🔗 [kaggle.com/datasets/mehdimka/path-planning](https://www.kaggle.com/datasets/mehdimka/path-planning)

### Supporting Research References

- Helbing, D. & Molnár, P. (1995). *Social force model for pedestrian dynamics.* Physical Review E, 51(5). — Crowd flow physics basis
- Daamen, W. & Hoogendoorn, S. (2003). *Experimental research of pedestrian walking behavior.* TRR, 1828. — Walking speed calibration
- Still, G.K. (2000). *Crowd Dynamics.* PhD Thesis, University of Warwick. — Venue density modeling
...
Datasets used for model training are publicly available and cited above.
Each dataset is used in accordance with its original license:
  - Stanford Drone Dataset — Stanford University (CC BY 4.0)
  - OpenTraj — INRIA/Inria-STARS (MIT License)
  - Path Planning Dataset — Kaggle Community (CC0 Public Domain)
